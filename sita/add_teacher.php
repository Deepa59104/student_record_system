...
// Include database connection and Teacher class
include '../db.php';
include 'Teacher.php';
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($data['first_name']) || empty($data['last_name']) || empty($data['email']) || empty($data['password'])) {
        ...
        // Try to add teacher to database
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active">
                            <option value="1" <?php echo (($_POST['is_active'] ?? 1) == 1) ? 'selected' : ''; ?>>Active</option>
                            <option value="0" <?php echo (($_POST['is_active'] ?? 1) == 0) ? 'selected' : ''; ?>>Inactive</option>
                        </select>
                    </div>
