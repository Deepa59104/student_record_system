...
if(isset($_POST['add'])) {
    ...
    if($result) {
        header("Location: teacher_list.php?success=added");
        exit();
    } else {
...
<div class="main">
    ...
    <div class="sub">Fill in the details to add a new teacher.</div>
    ...
    <div class="form-card">
        <form method="POST" onsubmit="return validateForm()">
            ...
            <div class="btn-row">
                <button type="submit" name="add" class="btn-save">+ Add Teacher</button>
